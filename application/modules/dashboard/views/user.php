                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="freelancer_name" placeholder="<?php echo $row['freelancer_name'] ?>">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="freelancer_location" placeholder="<?php echo $row['freelancer_location'] ?>">
                        </div>
                      </div>
                    </div>
                    <div class="row">
